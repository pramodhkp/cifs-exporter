...
func (c *CIFSCollector) Collect(ch chan<- prometheus.Metric) {
	...
	for _, block := range stats.Blocks {
		...
		if len(block.Metrics) == 22 {
		...
		} else if len(block.Metrics) == 33 {
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_smb", "Total SMB", nil, l), prometheus.GaugeValue, float64(block.Metrics[0]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_bytes_read", "Total Bytes Read", nil, l), prometheus.GaugeValue, float64(block.Metrics[1]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_bytes_written", "Total Bytes Written", nil, l), prometheus.GaugeValue, float64(block.Metrics[2]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_open_files_total", "Total Open Files", nil, l), prometheus.GaugeValue, float64(block.Metrics[3]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_open_files_on_server", "Open Files", nil, l), prometheus.GaugeValue, float64(block.Metrics[4]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_tree_connects_sent", "Total tree_connects sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[5]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_tree_connects_failed", "Total tree_connects failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[6]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_tree_disconnects_sent", "Total tree_disconnects sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[7]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_tree_disconnects_failed", "Total tree_disconnects failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[8]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_creates_sent", "Total creates sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[9]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_closes_sent", "Total closes sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[11]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_flushes_sent", "Total flushes sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[13]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_reads_sent", "Total reads sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[15]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_writes_sent", "Total writes sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[17]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_locks_sent", "Total locks sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[19]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_ioctls_sent", "Total ioctls sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[21]))
			...
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_query_directories_sent", "Total query_directories sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[23]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_query_directories_failed", "Total query_directories failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[24]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_change_notifies_sent", "Total change_notifies sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[25]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_change_notifies_failed", "Total change_notifies failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[26]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_query_infos_sent", "Total query_infos sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[27]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_query_infos_failed", "Total query_infos failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[28]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_set_infos_sent", "Total set_infos sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[29]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_set_infos_failed", "Total set_infos failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[30]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_oplocks_sent", "Total oplocks breaks sent", nil, l), prometheus.GaugeValue, float64(block.Metrics[31]))
			ch <- prometheus.MustNewConstMetric(prometheus.NewDesc("cifs_total_oplocks_failed", "Total oplocks breaks failed", nil, l), prometheus.GaugeValue, float64(block.Metrics[32]))
		}
	}
}
